                    ...
                    @if ($field->images->count() > 0)
                        @foreach ($field->images as $index => $image)
                            <div class="carousel-item {{ $index !== 0 ?: 'active' }}">
                                <img src="{{ Storage::url($image->image_path) }}" class="d-block object-fit-cover rounded"
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="row border border-0">
                            <div class="col-12">
                                ...
                                <a type="button" class="text-decoration-underline text-primary fw-bold"
                                                ...
                                                <div class="accordion" id="sewaRulesAccordion">
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseTwo" class="accordion-collapse collapse show"
                                                            ...
                                                            <div class="accordion-body">
                                                                <ul>
                                                                    <li><strong>Pelajar:</strong> Berlaku untuk siswa
                                                                        SD/SMP
                                                                        (harus menunjukkan kartu identitas).</li>
                                                                    <li><strong>Umum:</strong> Berlaku untuk semua
                                                                        kalangan
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseThree" class="accordion-collapse collapse"
                                                            ...
                                                            <div class="accordion-body">
                                                                <ul>
                                                                    <li>DP minimal <strong>50%</strong> dari total
                                                                        biaya.
                                                                    </li>
                                                                    <li>Pelunasan dilakukan sebelum sesi dimulai.</li>
                                                                    <li>Tidak ada pengembalian uang untuk pembatalan.
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="accordion-body">
                                                                <ul>
                                                                    ...
                                                                    <li><strong>Perubahan Waktu:</strong> Tidak
                                                                        diperkenankan mengubah jadwal setelah
                                                                        konfirmasi.
                                                                    </li>
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseSeven" class="accordion-collapse collapse"
                                                            ...
                                                            <div class="accordion-body">
                                                                ...
                                                                langsung di tempat dengan ketersediaan waktu sesuai
                                                                jadwal
                                                                yang tersedia.
                                                            </div>
                                                        </div>
