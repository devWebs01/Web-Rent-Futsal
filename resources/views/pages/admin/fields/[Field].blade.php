                            ...
                            <div class="position-relative" style="width: 200px; flex: 0 0 auto;">
                                <div class="card mt-5">
                                    <div class="card-img-top">
                                        <img src="{{ $image->temporaryUrl() }}" class="img" style="object-fit: cover;"
                                            width="200px" height="200px" alt="preview">
                    ...
                    <div class="d-flex flex-nowrap gap-3 overflow-auto" style="white-space: nowrap;">
                        @foreach ($field->images as $key => $image)
                            <div class="position-relative" style="width: 200px; flex: 0 0 auto;">
                                <div class="card mt-3">
                                    <div class="card-img-top">
                                        <img src="{{ Storage::url($image->image_path) }}" class="img" style="object-fit: cover;"
                                            width="200px" height="200px" alt="preview">
                                    </div>
                                </div>
                            </div>
                ...
                <form wire:submit="edit">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror"
                            wire:model="description" name="description" id="description" rows="3"></textarea>
                        @error('description')
