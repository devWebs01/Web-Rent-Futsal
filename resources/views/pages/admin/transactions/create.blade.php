...
<x-admin-layout>
    <x-slot name="title">Tambah booking Baru</x-slot>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="alert alert-primary" role="alert">
                        ...
                        <p>Pada halaman tambah booking, kamu dapat memasukkan informasi dari booking baru yang akan disimpan ke
                            sistem.
                        </p>
                    </div>
                </div>
                            ...
                            <div class="col-md">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('contoh1') is-invalid @enderror"
                                        ...
                                        placeholder="Enter booking contoh1" autofocus autocomplete="contoh1" />
                                    @error('contoh1')
                            ...
                            <div class="col-md">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('contoh2') is-invalid @enderror"
                                        ...
                                        placeholder="Enter booking contoh2" />
                                    @error('contoh2')
