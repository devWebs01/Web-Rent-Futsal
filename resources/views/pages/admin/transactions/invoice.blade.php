...
state([
    ...
    'total_price' => fn() => $this->booking->total_price,
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row gy-3 mb-3">
                    <div class="col-6">
                        <h4 class="text-uppercase fw-bold text-primary m-0">Invoice</h4>
                    </div>
                    <div class="col-6">
                        <h4 class="text-uppercase fw-bold text-primary text-end m-0">{{ $booking->invoice }}</h4>
                    </div>
                </div>
                <div class="row mb-3">
