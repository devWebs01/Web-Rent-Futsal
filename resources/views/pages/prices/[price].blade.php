...
state([
    'start_day' => fn() => $this->price->start_day,
    'end_day' => fn() => $this->price->end_day,
    'start_time' => fn() => Carbon\carbon::parse($this->price->start_time)->format('H:i'),
    'end_time' => fn() => Carbon\carbon::parse($this->price->end_time)->format('H:i'),
    'type' => fn() => $this->price->type,
    'cost' => fn() => $this->price->cost,
    'price',
]);
